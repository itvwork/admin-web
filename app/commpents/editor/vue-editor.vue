<template>
    <div class="vue-editor-wrap" :style='{width:width}'>
        <ul class="vue-editor-nav">
            ...
            <li class="vue-editor-nav-item" @click="_execCommand('strikeThrough')"><i class="icon icon-centerline"></i>
            </li>
            ...
            <li class="vue-editor-nav-item" :style="{backgroundColor:meun.iconColor}" @mouseover="meun.color=true"
                @mouseout="meun.color=false"><i :style="{color:meun.colorBg}" class="icon icon-color"></i>
                <div class="sel-color" v-show='meun.color'>
                    ...
                    <button class="jscolor  {valueElement:null,onFineChange:'vues.update(this)'}" value="cc66ff">自定义颜色
                    </button>
                </div>
            </li>
            <li class="vue-editor-nav-item" :style="{backgroundColor:meun.bgbgColor}" @mouseover="meun.bgcolor=true"
                @mouseout="meun.bgcolor=false"><i :style="{color:meun.bgiconColor}" class="icon icon-bgcolor"></i>
                <div class="sel-color" v-show='meun.bgcolor'>
                    ...
                    <button class="jscolor  {valueElement:null,onFineChange:'vues.backColor(this)'}" value="cc66ff">
                        自定义颜色
                    </button>
                </div>
            </li>
            <li class="vue-editor-nav-item" :style="{backgroundColor:meun.quoteBg}" @mouseover="meun.quote=true"
                @mouseout="meun.quote=false"><i :style="{color:meun.quoteIcon}" class="icon icon-quote"></i>
                ...
                <div class="sel-color" v-show='meun.quote'>
                    ...
                    <button class="jscolor  {valueElement:null,onFineChange:'vues.quoteColor(this)'}" value="cc66ff">
                        自定义颜色
                    </button>
                </div>
            </li>
            ...
            <li class="vue-editor-nav-item" @click="_execCommand('subscript')" @mouseover="meun.align=true"
                @mouseout="meun.align=false"><i class="icon icon-align"></i>
            ...
            <div class="tab1-img" v-show="tabimg==2">
                <ul class="list-pic">
                    <li class="pic-item" v-for="(item,index) in pic.data">
                      ...
                      <span class="vuk-deitor-loading" @click="getPics()">
                        <i v-show="pic.more=='加载中...'">
                        <img width="20" src="/style/admin/style/file/loading.svg" /></i>
                        {{pic.more}}
                      </span>
                </ul>
                ...
                if ((!alt) && (!ctrl) && (!shift)) {
                    switch (ev.keyCode) {
                        case 13:
                            ...
                            let section = window.getSelection().anchorNode;
                            if (section.nodeType == 3) section = section.parentNode;
                            while (section.nodeName.toLowerCase() !== "body") {
                                if (section.nodeName.toLowerCase() === "blockquote") break;
                                section = section.parentNode;
                            }

                            if (section.nodeName.toLowerCase() === "blockquote") {
                                let p = document.createElement("p");
                                p.innerHTML = "<br>";
                                this.insertAfter(p, section);
